...
export interface WithdrawCircuitGroth16VerifierInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ALPHA_X"
      | "ALPHA_Y"
...
export interface WithdrawCircuitGroth16Verifier extends BaseContract {
  connect(runner?: ContractRunner | null): WithdrawCircuitGroth16Verifier;
  waitForDeployment(): Promise<this>;

  interface: WithdrawCircuitGroth16VerifierInterface;
