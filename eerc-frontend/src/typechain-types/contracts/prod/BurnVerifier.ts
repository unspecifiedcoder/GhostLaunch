...
export interface BurnVerifierInterface extends Interface {
...
export interface BurnVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): BurnVerifier;
  waitForDeployment(): Promise<this>;

  interface: BurnVerifierInterface;
