...
export interface ITransferVerifierInterface extends Interface {
...
export interface ITransferVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): ITransferVerifier;
  waitForDeployment(): Promise<this>;

  interface: ITransferVerifierInterface;
