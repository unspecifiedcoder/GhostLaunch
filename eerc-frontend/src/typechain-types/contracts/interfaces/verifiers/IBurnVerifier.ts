...
export interface IBurnVerifierInterface extends Interface {
...
export interface IBurnVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): IBurnVerifier;
  waitForDeployment(): Promise<this>;

  interface: IBurnVerifierInterface;
