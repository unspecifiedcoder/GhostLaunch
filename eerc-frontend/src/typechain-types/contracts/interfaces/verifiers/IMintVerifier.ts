...
export interface IMintVerifierInterface extends Interface {
...
export interface IMintVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): IMintVerifier;
  waitForDeployment(): Promise<this>;

  interface: IMintVerifierInterface;
